...
export class HybridActionRuntimeInterpreter {
  public async interpret(params: {
    ...
    if (deterministic.matched && deterministic.parsed) {
      return {
        proposal: await actionRuntimeProposalService.createFromParsed({
...
export const hybridActionRuntimeInterpreter =
  new HybridActionRuntimeInterpreter();
