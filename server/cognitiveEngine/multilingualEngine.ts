...
const TRANSLATIONS: Record<string, string> = {
  ...
  'quanti': 'how many', 'quanto': 'how much', 'quale': 'which', 'dove': 'where', 'politica': 'policy', 'ufficio': 'office', 'prezzo': 'price', 'giorni': 'days',
  'कितने': 'how many', 'कितनी': 'how many', 'कहाँ': 'where', 'क्या': 'what', 'नीति': 'policy', 'कार्यालय': 'office', 'दिन': 'days',
  'कति': 'how many', 'कहाँ': 'where', 'कुन': 'which', 'के': 'what', 'बिदा': 'leave',
