...
function exactEntity(
  ...
  const matches = companyKnowledgeStore
    .listEntities({
      accountId,
      type,
      search: reference,
...
export class EffectiveDatasetOverlayService {
  public apply(params: {
    accountId: string;
    datasetId: string;
    version: DatasetVersion;
...
export const effectiveDatasetOverlayService =
  new EffectiveDatasetOverlayService();
